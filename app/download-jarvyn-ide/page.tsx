        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="bg-card border-border hover:bg-card/80 transition-all duration-300">
            ...
            <CardContent>
              ...
              <Button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground" asChild>
                <Link href="https://raw.githubusercontent.com/abhishekdhamale/TrusteD-V/main/docs/download-file/jarvyn-ide-windows">
          ...
          <Card className="bg-card border-border hover:bg-card/80 transition-all duration-300">
            ...
            <CardContent>
              ...
              <Button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground" asChild>
                <Link href="https://raw.githubusercontent.com/abhishekdhamale/TrusteD-V/main/docs/download-file/jarvyn-ide-macos">
                  <Download className="mr-2 h-5 w-5" />
                  Download for macOS
                </Link>
              </Button>
          ...
          <Card className="bg-card border-border hover:bg-card/80 transition-all duration-300">
            ...
            <CardContent>
              ...
              <Button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground" asChild>
                <Link href="https://raw.githubusercontent.com/abhishekdhamale/TrusteD-V/main/docs/download-file/jarvyn-ide-linux">
                  <Download className="mr-2 h-5 w-5" />
                  Download for Linux
                </Link>
              </Button>
